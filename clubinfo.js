...
export async function clubList(){
    ...
    allClubs.forEach((clubs) => {
        ...
        newButton.innerHTML = clubs.data().name;
        ...
        newButton.onclick = function(){
            ...
            setClub(clubs.data().name);
            //change the location of page to clubDash.html
            window.location.href = "clubDash.html";
        };
        //adds the button to the div
        document.getElementById('clubList').appendChild(newButton);
        document.getElementById('clubList').appendChild(document.createElement("br"));
    });
}